    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-xl-6">
                <h4>Daily <b class="text-danger">New Confirmed Cases</b> Count in <?php echo $city; ?>:</h4>
                <div id="dailyNewConfirm" style="width: 100%; height: 500px;"></div>
            </div>
            <div class="col-12 col-xl-6">
                <h4>Day-wise <b class="text-danger">Active Cases</b> in <?php echo $city; ?>:</h4>
                <div id="totalActive" style="width: 100%; height: 500px;"></div>
            </div>
            <br/>
            <hr/>
            <div class="col-12">
                <h4>Total <b class="text-danger">Cumulative Confirmed Cases</b> in <?php echo $city; ?>:</h4>
                <div id="totalConfirm" style="width: 100%; height: 500px;"></div>
            </div>
        </div>
    </div>

    <script src="../js/cityAmCharts.js"></script>
    <div class="footer">
